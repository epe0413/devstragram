    ...
    <body class="bg-gray-100">
        <header class="p-3 border-b bg-white shadow">
            <div class="container mx-auto flex justify-between items-center">
                <a href="{{ route('home') }}" class="text-lg font-black">
                    DevStagram
                </a>
                ...
                @auth
                    <nav class="flex gap-2 items-center">
                        <a
                            class="flex item-center gap-2 bg-white border p-2 text-gray-600 rounded-md text-xs uppercase font-bold cursor-pointer hover:bg-gray-600 hover:text-white"
